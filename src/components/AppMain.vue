<script>
import ComicBooksCards from "./ComicBooksCards.vue";
...
<template>
    <main>
        <div class="container">
            <div class="row">
                <div class="col" v-for="curCard in cardsArray">
                    <ComicBooksCards 
                    :cardThumb="curCard.thumb"
...
main {
    ...
    .row {
        @include flex($wrap: wrap, $gap: 20px, $align-items: stretch);
